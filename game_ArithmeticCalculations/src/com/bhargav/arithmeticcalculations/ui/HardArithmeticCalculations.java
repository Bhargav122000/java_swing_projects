...
public class HardArithmeticCalculations extends ArithmeticCalculations {
	private Random random;

	public HardArithmeticCalculations() {
		super();
		random = new Random();
	}
	...
	public void generateRightSubExpressionAndEvaluate() {
		...
		super.setHasRightSubExpressionOperator(true);
	...
	public void generateLeftSubExpressionAndEvaluate() {
		...
		super.setHasLeftSubExpressionOperator(true);

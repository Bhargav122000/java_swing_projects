...
public class LengthConversion {
	...
	public static void main(String[] args) {
		...
		try {
			...
			lengthConversion.setConvertUnitFrom(scanner.nextLine());
			System.out.println("Enter the unit to be converted into:");
			lengthConversion.setConvertUnitTo(scanner.nextLine());
			System.out.println("Enter the value to convert:");
			lengthConversion.setValue(Double.parseDouble(scanner.nextLine()));
			lengthConversion.convert();
			System.out.println(lengthConversion.getConvertedValue());

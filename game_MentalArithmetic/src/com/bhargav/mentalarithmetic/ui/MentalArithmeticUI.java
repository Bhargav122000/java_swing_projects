package com.bhargav.mentalarithmetic.ui;
...
public class MentalArithmeticUI implements ActionListener {
	...
	public void createTextPanel() {
		...
		textField.setFont(new Font("Showcard Gothic", Font.PLAIN, 40));
	...
	public void actionOfTimerButton() {
		...
		mentalArithmetic = new MentalArithmetic();
		mentalArithmetic.generateTerms();
		terms = mentalArithmetic.getTerms();
		isShown = false;
	...
	public void actionOfValidateButton() {
		try {
			...
			mentalArithmetic.setProvidedValue(providedValue);
			mentalArithmetic.updateScore();
			String score = String.valueOf(mentalArithmetic.getScore());
			scoreField.setText(score);

			if (mentalArithmetic.isValueMatched()) {
